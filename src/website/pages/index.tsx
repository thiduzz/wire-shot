      ...
      <Layout>
        ...
        <div className="page-content justify-center">
          <div className="hero flex flex-col items-center justify-center">
              { currentProfileAddress && <div className="flex flex-col items-center">
                  <div className="mb-10">
                      <h1 className="text-5xl text-purple-400 mb-2 text-center">You are connected!</h1>
                      <div>
                          Connected as <span className="text-purple-400 font-bold text-center">{currentProfileAddress}</span>
                      </div>
                  </div>
                  <div className="flex flex-row items-center gap-x-3.5">
                      <Link href="/restaurant"  passHref>
                          <div className="cursor-pointer hover:scale-125 transition-transform bg-white p-10 rounded border border-purple-400 shadow-lg w-48 h-48 flex flex-col text-center items-center justify-start leading-tight">
                              <IoRestaurantOutline size={50} className="text-purple-400 mb-5"/>
                      ...
                      <Link href="/customer" passHref>
                          <div className="cursor-pointer hover:scale-125 transition-transform bg-white p-10 rounded border border-purple-400 shadow-lg w-48 h-48 flex flex-col text-center items-center justify-start">
                              <IoQrCodeOutline size={50} className="text-purple-400 mb-5"/>
                              Check-in
                          </div>
                      </Link>
                  </div>
              ...
              { !currentProfileAddress && <button className="bg-purple-400 text-white p-5 rounded-lg" onClick={handleConnectWallet}>Connect</button>}
          </div>
        </div>
      </Layout>
  )
